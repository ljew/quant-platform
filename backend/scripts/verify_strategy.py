    ...
    "jk001": [
        {
            ...
            "note": "基准已对齐（+32.27% vs 平台 +32.45%）。\n"
                    "⚠️ 2026-09-16 修复引擎吞单 bug（_flush_pending_orders 的\n"
                    "   any(targets.values()) 会把『当日只有卖出』的止损/清仓单整批丢弃）后，\n"
                    "   此前所有数字作废。修复后同成本口径（slippage=0）：\n"
                    "     当前默认（ma + 即时清仓 + trailing 0.08） +111.56% / -27.87% / 夏普 0.986\n"
                    "     trailing 0.10（2026-09-16 前）          +107.58% / -29.57% / 夏普 0.920\n"
                    "     原版口径 origin                          +87.83% / -37.11% / 夏普 0.766\n"
                    "   平台已修掉原版「熊市风控永不触发」缺陷，故本段『偏离』参考值属预期：\n"
                    "   与聚宽逐条对齐已无意义，参考值仅保留作『原版基准线』。\n"
                    "   要与聚宽逐条对齐请用 trend_bear_mode='origin'。\n"
                    "聚宽该段平均仓位仅 51.6%（中性参数明明 0.9），-18.93% 回撤是半仓的\n"
                    "副产品而非策略设计的风控。",
            "comparable": True,
        },
        {
